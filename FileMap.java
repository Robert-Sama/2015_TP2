                     ...
                     */
                        ...
                        for (int j = 0; j < file.length; j++) {
                            if (words.get(k).equals(file[j])) {
                                ...
                                //String file
                                //String fileName = arrayList.get(i).get(1)[0];
                                //String fileName = String.join("", arrayList.get(i).get(1)); //Si fonctionne pas, juste 1 alors
                                //If dont work, essayer avec [0], si marche tjrs pas, essayer plus haut, si non, jsp..
